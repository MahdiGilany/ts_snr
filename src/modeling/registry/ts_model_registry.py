...
def LASSO_deeptime(
    ...
    **kwargs,
    ...
    from ..models.LASSO_deeptime import DeepTIMeModelMAML
    model = DeepTIMeModelMAML(
        input_chunk_length=input_chunk_length,
        output_chunk_length=output_chunk_length,
        random_state=random_state,
...
def reptile_deeptime(
    ...
    **kwargs,
    ...
    from ..models.reptile_deeptime import DeepTIMeModelReptile
    model = DeepTIMeModelReptile(
        input_chunk_length=input_chunk_length,
        output_chunk_length=output_chunk_length,
        random_state=random_state,
        batch_size=batch_size,
...
def inrplay_deeptime(
    ...
    **kwargs,
    ...
    from ..models.inrplay_deeptime import INRPlayDeepTIMeModel
    model = INRPlayDeepTIMeModel(
        input_chunk_length=input_chunk_length,
        output_chunk_length=output_chunk_length,
        random_state=random_state,
        batch_size=batch_size,
...
def twostage_deeptime(
    ...
    **kwargs,
    ...
    from ..models.twostage_deeptime import TwoStageDeepTIMeModel
    model = TwoStageDeepTIMeModel(
        input_chunk_length=input_chunk_length,
        output_chunk_length=output_chunk_length,
        random_state=random_state,
        batch_size=batch_size,
...
def twoomp_deeptime(
    ...
    **kwargs,
    ...
    from ..models.twoomp_deeptime import TwoOMPDeepTIMeModel
    model = TwoOMPDeepTIMeModel(
        input_chunk_length=input_chunk_length,
        output_chunk_length=output_chunk_length,
        random_state=random_state,
        batch_size=batch_size,
