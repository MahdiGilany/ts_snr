...
class DeepTimeExp(BasicExperiment):
    ...
    def setup_model(self):
        from models.deeptime_darts import DeepTIMeModel
        from utils.loss_registry import TorchLosses
        from utils.optimizer_scheduler import LambdaLRWrapper
        
        pl_trainer_kwargs = {}
        pl_trainer_kwargs.update(**self.config.trainer_config.__dict__)
        ...
        model = DeepTIMeModel(
            **self.config.model_config.__dict__,
            ...
            optimizer_kwargs=self.config.optimizer_config.__dict__,
            lr_scheduler_cls=LambdaLRWrapper,
            lr_scheduler_kwargs=self.config.scheduler_config.__dict__,
