...
# # # nbeats
# sbatch scripts/skynet_noise.sh version=benchmarkingV2 model_name=nbeats dataset_name=etth2 target_series_index=-1 multiple=7 output_chunk_length=96
...
# for n_nonzero_coefs in 45 75 105 135 165 195 #225 255
# do
#     # omp_deeptime
#     # sbatch scripts/skynet_noise_OMP.sh version=benchmarkingV2 model_name=omp_deeptime dataset_name=etth2 target_series_index=-1 multiple=7 output_chunk_length=96 n_nonzero_coefs=$n_nonzero_coefs
#     sbatch scripts/skynet_noise_OMP.sh version=benchmarkingV2 model_name=omp_deeptime dataset_name=exchange_rate target_series_index=-2 multiple=3 output_chunk_length=96 n_nonzero_coefs=$n_nonzero_coefs
#     sbatch scripts/skynet_noise_OMP.sh version=benchmarkingV2 model_name=omp_deeptime dataset_name=traffic target_series_index=-1 multiple=9 output_chunk_length=96 n_nonzero_coefs=$n_nonzero_coefs
# done
